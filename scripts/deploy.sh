...
# deploy contract
echo "$(soroban contract deploy --wasm target/wasm32-unknown-unknown/release/arch_v2.wasm --source telecom0 --network localhost_testnet)" \
 > .soroban/arch_v2-local-id